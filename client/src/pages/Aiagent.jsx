...
import { searchProperties, getLocationTrends } from "../api/api";
import {
  Building,
  MapPin,
  TrendingUp,
...
const AIPropertyHub = () => {
  ...
  useEffect(() => {
    ...
    document.title =
      "AI Property Hub | Urban Nest - Real Estate Market Analysis";
  }, []);
    ...
    return (
      <div className="flex flex-col items-center justify-center py-8 sm:py-12">
        ...
        <div className="text-center mb-6 max-w-lg px-4">
          <h3 className="text-xl sm:text-2xl font-medium  mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            {loadingStage === "properties"
